...
def visualize_results(y_train, y_train_pred, y_test, y_test_pred, train_accuracy, test_accuracy):
...
def main():
    # Step 1: Load dataset from CSV file
    csv_file = 'multiple_linear_regression_data.csv'  # Replace with your CSV file path
    ...
    # Step 6: Visualize the results
    visualize_results(y_train, y_train_pred, y_test, y_test_pred, train_accuracy, test_accuracy)
